...
class Graph(object):
    def __init__(self, nodes=None, edges=None):
        self.nodes = (
            nodes or []
        )  # you can Initialize a graph with some nodes or empty list
        self.edges = edges or []
        self.node_names = []
        self._node_map = {}
    ...
    def insert_edge(self, new_edge_val, node_from_val, node_to_val):
        ...
        new_edge = Edges(new_edge_val, node_from, node_to)
    ...
    def dfs(self, start_node_num):
        self._clear_visited()  # initializing all the nodes "not visited" before traversing
        start_node = self.find_node(start_node_num)
        return self.dfs_helper(
            start_node
        )  # calling helper func which will do actual traversing
